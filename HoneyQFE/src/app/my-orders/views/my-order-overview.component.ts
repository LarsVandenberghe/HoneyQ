...
@Component({
  selector: 'app-my-order-overview',
  imports: [DatePipe, CurrencyPipe, FontAwesomeModule],
  templateUrl: './my-order-overview.component.html',
  styleUrl: './my-order-overview.component.scss',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class MyOrderOverviewComponent {
